...
_C.path.data        = _C.path.root / 'data/'

_C.data.kpitrain    = _C.path.data / 'kpi_train_new.csv'
_C.data.user        = _C.path.data / 'user_new.csv'
_C.data.event       = _C.path.data / 'event_detail_1.csv'
